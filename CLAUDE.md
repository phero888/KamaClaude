...
This project is indexed by GitNexus as **KamaClaude** (1345 symbols, 2465 relationships, 38 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/KamaClaude/context` | Codebase overview, check index freshness |
| `gitnexus://repo/KamaClaude/clusters` | All functional areas |
| `gitnexus://repo/KamaClaude/processes` | All execution flows |
| `gitnexus://repo/KamaClaude/process/{name}` | Step-by-step execution trace |
